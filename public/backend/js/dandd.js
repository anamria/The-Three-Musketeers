var drag1 = document.getElementById('drag1');
        ...
        var correctAnswers = [drag2, drag1, drag4, drag3, drag5];
        var totalAnswers = 0;
        ...
        function mouseUp (e) {
            ...
            */
            ...
            if (trueTop >= (drop1.offsetTop - 50) && trueTop <= (drop1.offsetTop + 50) &&
                trueLeft <= (drop5.offsetLeft + 50) && trueLeft >= (drop1.offsetLeft - 50)) {
            ...
            function checkAnswers () {
                ...
                if (correct === 5) {
                    document.getElementById('response').textContent = 'Hore, jawaban kamu benar semua!';
                    document.getElementById('check-answers').classList.add('hidden');
                    document.getElementById('play-again').classList.remove('hidden');
                    document.getElementById('play-again').addEventListener('click', restartGame);
                } else {
                    document.getElementById('response').textContent = (5 - correct) + " jawaban kamu salah. Tetaplah mencoba!";
                    document.getElementById('check-answers').classList.add('hidden');
                    document.getElementById('play-again').classList.remove('hidden');
                    document.getElementById('play-again').addEventListener('click', restartGame);
                }
